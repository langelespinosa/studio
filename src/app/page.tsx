...
export default function Home() {
  ...
  const [isPremium, setIsPremium] = useState(false); // State to simulate premium status
 ...
 />
        ...
        <div className="w-1/4 bg-gray-200 p-4 text-center hidden md:block"> {/* Banner on the right */}
 <div className="mb-8">
 Banner ejemplo
 </div>
 <div>
 <h3 className="text-lg font-semibold mb-2">¿Porqué debería hacerme premium?</h3>
 <Link href="/premium" className="text-blue-600 hover:underline">Descubre los beneficios</Link>
 </div>
        </div>
      </div>
      </>
