...
export default function Navbar() {
  ...
  return (
    <div>
      <nav className="block w-full max-w-screen px-4 py-4 mx-auto navbar-background sticky top-3 shadow lg:px-8 backdrop-blur-lg backdrop-saturate-150 z-[9999]">
        <div className="container flex flex-wrap items-center justify-between mx-auto text-slate-800">
          <Link
            href="/"
            className="mr-4 block cursor-pointer py-1.5 text-pink-600 font-bold text-3xl"
          >
            AI-xolotl
          </Link>
          ...
          >
            <div className="flex flex-row items-center border-b pb-4">
              <Link
                href="/"
                className="cursor-pointer text-pink-600 font-bold text-xl pt-4 ps-4"
              >
                AI-xolotl
              </Link>
              <button
            ...
            <ul className="flex flex-col h-full gap-4 p-4">
              ...
              <li className="mt-4">
                <Link href={`/login`}>
                    <button className="bg-orange-600 hover:bg-orange-500 text-white px-8 py-2 rounded-md">
                    Acceder
                    </button>
                </Link>
              </li>
