...
export function RecipeDisplay({ recipe }: RecipeDisplayProps) {
  return (
    <div className="space-y-6">
      <div>
          <h3 className="text-xl font-semibold mb-3 text-pink-600">Ingredientes</h3>
      ...
      <div>
        <h3 className="text-xl font-semibold mb-3 text-pink-600">Instrucciones</h3>
      ...
      <div>
        <h3 className="text-xl font-semibold mb-3 text-pink-600">Recomendaciones</h3>
